...
urlpatterns = [
    ...
    path('patch_interval/<int:room_id>/<int:climate_interval_id>', views.patch_interval, name='patch_interval'),
    path('delete_interval/<int:room_id>/<int:climate_interval_id>', views.delete_interval, name='delete_interval'),
